    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-5 py-20">
        ...
        <div className="prose prose-sm mt-8 max-w-none text-foreground/85">
          <p>Spotlight Humanity ("we", "us") respects your privacy. This page explains what data we collect when you donate or browse our site and how we use it.</p>
          ...
          <p>You can request access, correction or deletion of your data at any time by emailing <a className="text-primary underline" href="mailto:privacy@spotlight-humanity.org">privacy@spotlight-humanity.org</a>.</p>
        </div>
      </main>
      <SHFooter />
