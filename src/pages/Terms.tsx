    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-5 py-20">
        ...
        <div className="prose prose-sm mt-8 max-w-none text-foreground/85">
          <p>By using this website and donating to Spotlight Humanity you agree to the following terms.</p>
          <h2 className="mt-8 text-xl font-bold">Donations</h2>
          <p>All donations are processed in USD via Stripe. Recurring donations renew monthly until cancelled. You can cancel any recurring donation by contacting us at <a className="text-primary underline" href="mailto:hello@spotlight-humanity.org">hello@spotlight-humanity.org</a>.</p>
